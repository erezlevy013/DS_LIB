 ...
 * @retval QUEUE_FULL - if there is no more room to add 
 */
 ...
 * @return Queue_Result -
 * @retval QUEUE_SUCCESS - on seccess
 * @retval QUEUE_UNINITIALIZED_ERROR - if _queue is NULL or if _item is NULL
 * @retval QUEUE_EMPTY - if queue is empty
 */
