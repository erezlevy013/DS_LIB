...
typedef enum Heap_ResultCode {
	...
	HEAP_VECTOR_REALLOCATION_FAILED,
	HEAP_VECTOR_ALLOCATION_FAILED,
	HEAP_VECTOR_UNDERFLOW_ERROR,
	HEAP_VECTOR_OVERFLOW_ERROR
} HeapResultCode;
 ...
 * @retval HEAP_VECTOR_OVERFLOW_ERROR error , blockszie = 0
  */
