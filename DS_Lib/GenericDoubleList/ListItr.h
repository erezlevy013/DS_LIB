 ...
 * @return NULL if _list empty
 * @return same node if is begin iterator
 * @return prev node
 */
 ...
 * @return NULL if _list empty or _element = NULL
 * @return prev data
 */
 ...
 * @return NULL if _list empty or allocation fail
 * @return new begin
 * @return NULL if _list empty
 */
